...
router.patch('/admin/reorder', authenticateAdmin, validateBody(reorderSchema), galleryController.reorder);
router.put('/admin/reorder', authenticateAdmin, validateBody(reorderSchema), galleryController.reorder);
...
router.get('/admin/:id', authenticateAdmin, validateParams(uuidParamSchema), galleryController.getById);
...
router.post('/', authenticateAdmin, validateBody(upsertGalleryItemSchema), galleryController.create);
router.put('/:id', authenticateAdmin, validateParams(uuidParamSchema), validateBody(upsertGalleryItemSchema.partial()), galleryController.update);
