...
router.patch('/admin/reorder', authenticateAdmin, validateBody(reorderSchema), navItemController.reorder);
router.put('/admin/reorder', authenticateAdmin, validateBody(reorderSchema), navItemController.reorder);
...
router.get('/admin/:id', authenticateAdmin, validateParams(uuidParamSchema), navItemController.getById);
...
router.put('/:id', authenticateAdmin, validateParams(uuidParamSchema), validateBody(upsertNavItemSchema.partial()), navItemController.update);
