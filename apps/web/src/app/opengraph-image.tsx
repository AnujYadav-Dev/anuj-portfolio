  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          Crafting high-performance web applications, scalable distributed systems, and elegant user
          experiences.
        </p>
      </div>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontSize: '18px', fontWeight: 700, color: '#ffffff' }}>Anuj Yadav</span>
