...
- Color palette: `color.text.primary=#212529`, `color.text.secondary=#4b4b4b`, `color.text.tertiary=#ff8c42`, `color.surface.base=#faf8f5`, `color.surface.muted=#e5ded6`
- Spacing scale: `space.1=8px`, `space.2=12px`, `space.3=16px`, `space.4=64px`, `space.5=96px`
...
- Include known page component density: links (33), buttons (4), navigation (4), lists (3).
